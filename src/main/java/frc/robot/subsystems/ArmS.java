...
public class ArmS extends SubsystemBase {
  ...
  .withFollowers(Pair.of(new TalonFX(38, TunerConstants.kCANBus2), false))
  ...
  private TalonFX motor39 = new TalonFX(39, TunerConstants.kCANBus2);

  // Create our SmartMotorController from our Spark and config with the NEO.
  private SmartMotorController armSmc = new TalonFXWrapper(motor39, DCMotor.getFalcon500(2), armSmcConfig);

  private final MechanismPositionConfig robotToMechanism = new MechanismPositionConfig()
      .withRelativePosition(new Translation3d(Meters.of(0.1), Meters.of(0), Meters.of(0.15)));


  private ArmConfig mainArmCfg = new ArmConfig(armSmc)
  ...
  // Arm Mechanism
  private Arm mainArm = new Arm(mainArmCfg);
   ...
   */
  public Command set(double dutycycle) { return mainArm.set(dutycycle);}

  /**
   * Run sysId on the {@link Arm}
   */
  public Command sysId() { return mainArm.sysId(Volts.of(7), Volts.of(2).per(Second), Seconds.of(4));}
